...
const Wjhtk = async ({ searchParams }) => {
  const idTopic = Number(searchParams?.uid) || 1; // الحصول على رقم الصفحة من الاستعلام
  //href={`/pages/wjhtk?title?=&${data?.title_Topics}&uid=${data?.ID_Topics}`}
